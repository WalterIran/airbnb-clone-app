...
function Header({placeholder}) {
    ...
    return (
        <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10E'>
            ...
            <div className='flex items-center md:border-2 rounded-full py-2 md:shadow-sm'>
                <input 
                    ...
                    className='flex-grow pl-2 overflow-x-hidden sm:pl-5 bg-transparent outline-none text-sm text-gray-600 placeholder-gray-400 overflow-ellipsis' 
                />
